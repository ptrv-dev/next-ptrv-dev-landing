      ...
      <div className="container py-5">
        <div className="flex items-center justify-between pb-5">
          ...
          <div className="flex gap-7">
            <a href="mailto:3gomane@gmail.com">
              <svg
                width="25"
                height="24"
                viewBox="0 0 25 24"
              ...
              >
                <path
                  ...
                  d="M24.2953 8.94375C24.4781 8.79844 24.75 8.93437 24.75 9.16406V18.75C24.75 19.9922 23.7422 21 22.5 21H3C1.75781 21 0.75 19.9922 0.75 18.75V9.16875C0.75 8.93438 1.01719 8.80312 1.20469 8.94844C2.25469 9.76406 3.64688 10.8 8.42813 14.2734C9.41719 14.9953 11.0859 16.5141 12.75 16.5047C14.4234 16.5188 16.125 14.9672 17.0766 14.2734C21.8578 10.8 23.2453 9.75938 24.2953 8.94375ZM12.75 15C13.8375 15.0188 15.4031 13.6313 16.1906 13.0594C22.4109 8.54531 22.8844 8.15156 24.3187 7.02656C24.5906 6.81562 24.75 6.4875 24.75 6.14062V5.25C24.75 4.00781 23.7422 3 22.5 3H3C1.75781 3 0.75 4.00781 0.75 5.25V6.14062C0.75 6.4875 0.909375 6.81094 1.18125 7.02656C2.61563 8.14687 3.08906 8.54531 9.30938 13.0594C10.0969 13.6313 11.6625 15.0188 12.75 15Z"
                  fill="#F5F5F4"
                />
              </svg>
            </a>
            ...
            >
              ...
              >
                <path
                  className="group-hover:fill-teal-500 transition-colors"
                  d="M12.7498 0.375C6.12447 0.375 0.75647 5.57812 0.75647 12C0.75647 18.4219 6.12447 23.625 12.7498 23.625C19.3752 23.625 24.7432 18.4219 24.7432 12C24.7432 5.57812 19.3752 0.375 12.7498 0.375ZM18.6401 8.33906L16.6719 17.3297C16.5268 17.9672 16.1351 18.1219 15.5886 17.8219L12.5902 15.6797L11.1443 17.0297C10.9847 17.1844 10.8493 17.3156 10.5398 17.3156L10.7526 14.3578L16.3092 9.49219C16.551 9.28594 16.256 9.16875 15.9368 9.375L9.06961 13.5656L6.10996 12.6703C5.46677 12.4734 5.45226 12.0469 6.24537 11.7469L17.8083 7.425C18.3451 7.2375 18.8142 7.55156 18.6401 8.33906Z"
                  fill="#F5F5F4"
                />
              </svg>
            </a>
        ...
        <div>
          <p className="text-center">© 2022 ptrv-dev • All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
